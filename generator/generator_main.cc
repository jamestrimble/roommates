...
int main(int argc, char** argv) {
    if (argc < 5) {
        ...
        std::cout << "options for type: 1=edge gen, 2=edge gen (using binomial dist),"
        ...
        switch(gen_type) {
            ...
            case 3: gen = new GeneratorEdgeGenerationComplement(n, p, rgen); break;
            case 4: gen = new GeneratorEdgeSelection(n, p, rgen); break;
            case 5: gen = new GeneratorSMMorph(n, p, rgen); break;
            case 6: gen = new GeneratorCompleteGraph(n, p, rgen); break;
        }
